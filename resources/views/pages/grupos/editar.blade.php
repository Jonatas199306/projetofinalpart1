      ...
      <div class="col-md-12">
        <div class="card">
          ...
          <div class="card-content">
            <div class="card-body">
                <form class="form-horizontal" method="POST" action="/grupos/atualizar/<?=$role->id?>" novalidate autocomplete="off">
                    @csrf
                    @method('PATCH')
                <div class="row">
                  <div class="col-sm-6">
                    <div class="form-group">
                      ...
                      <div class="controls">
                        <input type="text" name="name" id="name"  value="<?=$role->name; ?>" class="form-control name" placeholder="Nome"
                          required
...
<script src="{{asset('js/grupos/editar.js')}}"></script>
