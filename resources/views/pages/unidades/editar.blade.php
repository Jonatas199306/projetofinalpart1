            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form-horizontal" method="POST" action="/unidades/atualizar/<?=$unidade->id?>" autocomplete="off">
                                @csrf
                                <div class="row">
                                    <div class="col-lg-3">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <select name="tipo" id="tipo" class="form-control" required>
                                                    <option value="ESTADUAL" {{isset($unidade) && $unidade->tipo === 'ESTADUAL' ? 'selected' : ''}}>ESTADUAL</option>
                                                    <option value="NACIONAL" {{isset($unidade) && $unidade->tipo === 'NACIONAL' ? 'selected' : ''}}>NACIONAL</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <select name="ativo" id="ativo" class="form-control">
                                                    <option value="S" {{isset($unidade) && $unidade->ativo === 'S' ? 'selected' : ''}}>SIM</option>
                                                    <option value="N" {{isset($unidade) && $unidade->ativo === 'N' ? 'selected' : ''}}>NÃO</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="number"
                                                       ...
                                                       value="<?=$unidade->taxa_administrativa?>"
