                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form-horizontal" method="POST"
                                  action="/afiliadas-contatos/atualizar/<?=$afiliadaContato->id?>"
                                            ...
                                            <div class="controls">
                                                <select name="afiliadas_id" id="afiliada" class="form-control" required>
                                                    ...
                                                    @foreach($afiliadas as $afiliada)
                                                        <option value="{{$afiliada->id}}" {{$afiliadaContato->afiliadas_id == $afiliada->id ? 'selected' : ''}}>{{$afiliada->nome}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="telefone" id="telefone" class="form-control"
                                                       value="{{ $afiliadaContato->telefone }}"
