                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form-horizontal" method="POST"
                                  action="/afiliadas-tipos/atualizar/<?=$afiliadaTipo->id?>"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <select name="ativa" id="ativa" class="form-control" required>
                                                    ...
                                                    <option value="S" {{$afiliadaTipo->ativa == 'S' ? 'selected' : ''}}>
                                                        SIM
                                                    </option>
                                                    <option value="N" {{$afiliadaTipo->ativa == 'N' ? 'selected' : ''}}>
                                                        NÃO
                                                    </option>
                                                </select>
                                            </div>
