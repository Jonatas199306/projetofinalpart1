            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <a style="float: right;" href="{{route('bancos.index')}}"
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form-horizontal" method="POST" action="{{route('bancos.salvar')}}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <select name="ativo" id="ativo" class="form-control" required>
                                                    <option value="S" {{old('ativo') == 'S' ? 'selected' : ''}}>
                                                        SIM
                                                    </option>
                                                    <option value="N" {{old('ativo') == 'N' ? 'selected' : ''}}>
                                                        NÃO
                                                    </option>
                                                </select>
                                            </div>
