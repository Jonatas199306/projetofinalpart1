        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <div class="row ">
                        <form action="{{ route('bancos.pesquisar') }}" method="POST" class="form-inline">
                            @csrf
                            <div class="col-sm-6">
                            ...
                            <div class="col-sm-6">
                                ...
                                <a href="{{ route('bancos.cadastrar') }}" class="btn btn-primary">Cadastrar</a>
                            </div>
                        </form>
                    </div>
                </div>
                        ...
                        <table class="table mb-0">
                            ...
                            @foreach($bancos as $banco)
                                <tr>
                                    <td><?=$banco['id']?></td>
                                    <td><?=$banco->nome?></td>
                                    <td><?=$banco->ativo === 'S' ? 'SIM' : 'NÃO'?></td>
                                    <td width="140px">
                                        <a href="{{ route('bancos.editar',$banco->id) }}"><i
                                                class="badge-circle badge-circle-light-primary bx bxs-pencil font-medium-1"></i></a>
                                        <a href="{{ route('bancos.deletar',$banco->id) }}"><i
