          ...
          <div class="card disable-rounded-right mb-0 p-2 h-100 d-flex justify-content-center">
            <div class="card-header pb-1">
              <div class="card-title">
                <h4 class="text-center mb-2">CADASTRAR</h4>
              </div>
            </div>
            <div class="text-center">
              <p> <small> Por favor, insira os dados para cadastro </small>
              </p>
            </div>
              ...
              <div class="card-body">
                <form method="POST" action="{{ route('register') }}">
                  ...
                  <div class="form-group mb-50">
                    <label class="text-bold-600" for="name">Nome</label>
                  ...
                  <div class="form-group mb-2">
                    <label class="text-bold-600" for="password-confirm">Confirmar Senha</label>
                  ...
                  <button type="submit" class="btn btn-primary glow position-relative w-100">Cadastrar<i
                    id="icon-arrow" class="bx bx-right-arrow-alt"></i></button>
                </form>
                <hr>
                <div class="text-center"><small class="mr-25">já tem uma conta?</small>
                  <a href="{{asset('login')}}"><small>Entrar</small> </a>
                </div>
              </div>
            </div>
          </div>
